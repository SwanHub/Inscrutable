class Game < ActiveRecord::Base
  ...
  def sync_board_state(board)
      self.update(board_0: board[0])
      self.update(board_1: board[1])
      self.update(board_2: board[2])
      self.update(board_3: board[3])
      self.update(board_4: board[4])
      self.update(board_5: board[5])
      self.update(board_6: board[6])
      self.update(board_7: board[7])
      self.update(board_8: board[8])
      board
  end
